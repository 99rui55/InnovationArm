...
public class TrajectoryGenerator {
    ...
    private PathPoint createAllianceRelativePathPoint(Translation2d position, Rotation2d heading,
    ...
    public PathPoint[] generate() {
        ...
        for (int i = 0; i < path.length; i++) {
            ...
            path[i] = createAllianceRelativePathPoint(position.getTranslation(), heading,
